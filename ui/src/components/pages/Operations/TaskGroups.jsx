          ...
          <div className="cu-section-left" style={{ display: 'flex', alignItems: 'center', cursor: 'pointer', flex: 1 }} onClick={() => {
            ...
            {editingListId === list.id ? (
              ...
              <>
                ...
                {list.project && (
                  <span className="tg-project-badge" style={{ marginLeft: '8px', fontSize: '0.7rem' }}>
                    {list.project.name}
                  </span>
                )}
            ...
            <table className="cu-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
              ...
              <tbody>
                {(() => {
                  ...
                  // Sort main tasks by Task Name in ascending A-Z order
                  ...
                  return sortedMainTasks.flatMap(task => {
                    ...
                    const parentRow = (
                      <tr key={task.id} className="cu-row" onClick={() => { setViewingTask(task); setDrawerEditMode(false); setShowTaskViewModal(true); }} style={{ borderBottom: '1px solid #f1f5f9', cursor: 'pointer', transition: 'background 0.15s' }}>
                        ...
                        <td className="cu-td cu-td-list" style={{ padding: '0.85rem 1.25rem', textAlign: 'center' }}>
                          <span style={{
                            background: meta.bg,
                            color: meta.fg,
                        ...
                        <td className="cu-td cu-td-actions" onClick={e => e.stopPropagation()} style={{ padding: '0.85rem 1.25rem' }}>
                          <div className="cu-row-actions" style={{ display: 'flex', gap: '0.5rem', justifyContent: 'center' }}>
                            {can('tasks', 'edit') && (
                    ...
                    if (isExpanded) {
                      // Sort subtasks by Task Name in ascending A-Z order
