...
export default function Clients({ user }) {
  ...
  const fetchClients = async () => {
    ...
    try {
      ...
      apiTimings.push({ name: 'GET /clients', duration: dFetch, items: (data || []).length });
      ...
      methodTimings.push({ name: 'Alphabetical Company Sorting', duration: dSort });
      ...
      logPagePerf('CLIENTS PAGE', apiTimings, methodTimings, pageStartMs);
    } catch (error) {
