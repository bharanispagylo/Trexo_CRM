  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        methodTimings.push({ name: 'Employee Filtering & Alphabetical Sorting', duration: dProc });
        ...
        logPagePerf('DAILY LOAD INDIVIDUAL PAGE', apiTimings, methodTimings, pageStartMs);
      } catch (err) {
